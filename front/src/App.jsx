...
const AcademicEdit = lazy(() => import("./pages/admin/academic/academic-edit"));
...
const AdminPayments = lazy(() => import("./pages/admin/payment"));
...
const Students = lazy(() => import("./pages/admin/student"));
const StudentAddPage = lazy(() => import("./pages/admin/student/student-add"));
const StudentEditPage = lazy(() =>
  import("./pages/admin/student/student-edit")
);

// const StudentsView=lazy(()=>import("./pages/admin/student/student-see"))

// TEACHERS_PAGE
const PROFCOURS = lazy(() => import("./pages/teacher/cours"));
const SingleProfCours = lazy(() => import("./pages/teacher/cours/SingleCours"));

const StudentCours = lazy(() => import("./pages/student/cours"));
const StudentPayments = lazy(() => import("./pages/student/payment"));
const StudentPaymentAdd = lazy(() =>
  import("./pages/student/payment/payment-create")
);
      ...
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          <Route element={<ProtectedRoutes roles={["Admin"]} />}>
            ...
            <Route path="releves" element={<AdminPayments />} />
            ...
            <Route path="academic-year" element={<Academic />} />
            <Route path="academic-year-edit/:id" element={<AcademicEdit />} />
            ...
            <Route path="admin-create" element={<AdminAddPage />} />
            <Route path="admin-edit/:id" element={<AdminAddPage />} />
            <Route path="admin-view/:id" element={<AdminView />} /> */}
          </Route>
          <Route element={<ProtectedRoutes roles={["Teacher"]} />}>
            <Route path="mes-cours" element={<PROFCOURS />} />
            <Route path="mes-cours/:id" element={<SingleProfCours />} />
          </Route>
          <Route element={<ProtectedRoutes roles={["Student"]} />}>
            <Route path="cours" element={<StudentCours />} />
            <Route path="payments" element={<StudentPayments />} />
            <Route path="payments-add" element={<StudentPaymentAdd />} />
            {/* <Route path="mes-cours/:id" element={<SingleProfCours />} /> */}
          </Route>
