export const menuItems = [
...

  {
    ...
    child: [
      ...
      // },
      // {
      //   childtitle: "Gestion des étudiants",
      //   childlink: "dashboard",
      // },
      {
        childtitle: "Gestion des paiements",
        childlink: "releves",
      },
      {
        childtitle: "Années academiques",
        childlink: "academic-year",
      },
      {
...
export const studentItems = [
...

  {
    ...
    child: [
      ...
      {
        childtitle: "Mes cours",
        childlink: "cours",
      },
      {
        childtitle: "Mes paiements",
        childlink: "payments",
      },
...
export const teacherItems = [
...

  {
    ...
    child: [
      ...
      {
        childtitle: "Devoirs",
        childlink: "mes-devoirs",
      },
      {
        childtitle: "Administration de présence",
        childlink: "attendance-list",
      },
    ],
  },
];
