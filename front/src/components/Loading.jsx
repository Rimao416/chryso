...
import LogoWhite from "@/assets/images/logo/time.jpeg";
import Logo from "@/assets/images/logo/time.jpeg";
...
const Loading = () => {
  ...
  return (
    <div
      className={
        !isAuth ? "flex flex-col items-center justify-center app_height" : ""
      }
    >
      {!isAuth && (
        <div className="mb-3">
